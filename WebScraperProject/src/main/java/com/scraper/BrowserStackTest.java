...
public class BrowserStackTest {
    ...
    public void setupDriver(@Optional("Chrome") String browser, 
        ...
        caps.setCapability("build", "BrowserStack WebScraper Build");
        caps.setCapability("project", "Web Scraper");
        
        String BROWSERSTACK_URL = "https://" + System.getenv("BROWSERSTACK_USERNAME") + ":" +
